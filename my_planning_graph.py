...
class ActionLayer(BaseActionLayer):
    ...
    def _inconsistent_effects(self, actionA, actionB):
        ...
        return any([~literal in actionA.effects for literal in actionB.effects] + [~literal in actionB.effects for literal in actionA.effects])
    ...
    def _interference(self, actionA, actionB):
        ...
        """
        # TODO: implement this function
        return any([~literal in actionA.preconditions for literal in actionB.effects] + [~literal in actionB.preconditions for literal in actionA.effects])
    ...
    def _competing_needs(self, actionA, actionB):
        ...
        """
        # TODO: implement this function
        return any([self.parent_layer.is_mutex(literalA,literalB) for literalA in actionA.preconditions for literalB in actionB.preconditions])
...
class PlanningGraph:
    ...
    def level_cost(self, goal_literal):
        for cost in range(len(self.literal_layers)-1):
            if goal_literal in self.literal_layers[cost]:
                return cost
        return 0
    ...
    def h_levelsum(self):
        ...
        for goal_literal in self.goal:
            costs.append(self.level_cost(goal_literal))
        return sum(costs)
    ...
    def h_setlevel(self):
        ...
        self.fill()
        for cost in range(len(self.literal_layers)-1):
            if all([goal_literal in self.literal_layers[cost] for goal_literal in self.goal]):
                if not any([self.literal_layers[cost].is_mutex(goalA,goalB) for goalA in self.goal for goalB in self.goal]):
                    return cost
        return 0
